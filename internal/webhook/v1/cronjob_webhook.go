...
import (
	...
	batchv1 "github.com/trphume/cronjob-controllers-k8s/api/v1"
)
...
// +kubebuilder:webhook:path=/mutate-batch-cronjob-trphume-com-v1-cronjob,mutating=true,failurePolicy=fail,sideEffects=None,groups=batch.cronjob.trphume.com,resources=cronjobs,verbs=create;update,versions=v1,name=mcronjob-v1.kb.io,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-batch-cronjob-trphume-com-v1-cronjob,mutating=false,failurePolicy=fail,sideEffects=None,groups=batch.cronjob.trphume.com,resources=cronjobs,verbs=create;update,versions=v1,name=vcronjob-v1.kb.io,admissionReviewVersions=v1
...
func validateCronJob(cronjob *batchv1.CronJob) error {
	...
	return apierrors.NewInvalid(
		schema.GroupKind{Group: "batch.cronjob.trphume.com", Kind: "CronJob"},
